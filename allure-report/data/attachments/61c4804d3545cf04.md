...
Call log:
  - Expect "toBeEnabled" with timeout 600000ms
...
```ts
  ...
  45  |         await expect(this.setLocationButton).toBeEnabled({ timeout: 600000});
  46  |         await this.setLocationButton.click();
  47  |     }
  48  | 
  49  |     async selectPickUp(): Promise<void> {
  50  |         await expect(this.pickupButton).toBeEnabled({ timeout: 600000});
  51  |         await this.pickupButton.click();
  52  |     }
  53  | 
  54  |     async enterSearchQuery(locationQuery: string): Promise<void> {
> 55  |         await expect(this.storeSearchField).toBeEnabled({ timeout: 600000});
      |                                             ^ Error: expect(locator).toBeEnabled() failed
