...
Locator: locator('.adyen-checkout__input.adyen-checkout__input--large.adyen-checkout__card__cardNumber__input')
Expected: editable
...
Call log:
  ...
  - waiting for locator('.adyen-checkout__input.adyen-checkout__input--large.adyen-checkout__card__cardNumber__input')
