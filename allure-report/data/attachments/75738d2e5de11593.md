...
```ts
  ...
  81  |         await this.fillText(this.firstNameField, firstName);
  82  |         await this.fillText(this.lastNameField, lastName);
  83  |         await this.fillText(this.emailAddressField, email);
  84  |         await this.fillText(this.phoneNumberField, phone);
  85  |     }
  86  | 
...
> 97  |         await this.manualCardEntryButton.isEnabled();
  ...
  102 |         await this.fillText(this.cardNumberField, cardNumber);
  103 |         await this.fillText(this.expiryDateField, expiryDate);
  104 |         await this.fillText(this.securityCodeField, securityCode);
  105 |     }
  106 | 
