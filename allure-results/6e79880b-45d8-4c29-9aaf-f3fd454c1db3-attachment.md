...
```ts
  ...
  45  |         await expect(this.setLocationButton).toBeVisible();
  46  |         await this.setLocationButton.click();
  47  |     }
  48  | 
  49  |     async pickUpButtonIsVisible(): Promise<boolean> {
  50  |         return await this.pickupButton.isVisible();
  51  |     }
  52  | 
  53  |     async selectPickUp(): Promise<void> {
  54  |         await this.pickUpButtonIsVisible();
  55  |         await this.pickupButton.click();
  56  |     }
  57  | 
  58  |     async enterSearchQuery(locationQuery: string): Promise<void> {
> 59  |         await expect(this.storeSearchField).toBeVisible();
      |                                             ^ Error: expect(locator).toBeVisible() failed
  ...
  66  |         await this.suggesAddressList.waitFor({ state: 'visible' });
