                                      ...
                                      - generic:
                                        - iframe [ref=e68]: <p>Your browser does not support iframes.</p>:
                                          - generic [active] [ref=f17e1]:
                                            - textbox [ref=f17e2]
                                            - generic:
                                              - textbox "Expiry date" [ref=f17e3]:
                                                - /placeholder: ""
                                                - text: 03/30
                                              - generic [ref=f17e4]: Front of card in MM/YY format
                                        - generic:
                                          - img "Field valid"
                                      ...
                                      - generic:
                                        - iframe [ref=e69]: <p>Your browser does not support iframes.</p>:
                                          - generic [active] [ref=f18e1]:
                                            - textbox [ref=f18e2]
                                            - generic:
                                              - textbox "Security code" [ref=f18e3]:
                                                - /placeholder: ""
                                                - text: "737"
                                              - generic [ref=f18e4]: 3 digits on back of card
                                        - generic:
                                          - img
                                          - img "Security code"
                                        - generic:
